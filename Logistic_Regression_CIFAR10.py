...
- Results: Accuracy is about 27% after 20 epochs. Increasing training to 100 epochs increases accuracy to 29%.
...
test_dataset = CIFAR10(root='data/', train=False, transform=trans)
...
#history5 = fit(80, 0.001, model, train_loader, val_loader) # 0.29 accuracy
...
torch.save(model.state_dict(), 'cifar-logistic-20-epochs.pth')

# Sanity Check
model2 = CIFARModel()
model2.load_state_dict(torch.load('cifar-logistic-20-epochs.pth'))
model2.state_dict()
